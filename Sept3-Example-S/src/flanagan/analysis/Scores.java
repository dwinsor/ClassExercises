...
*               7 December 2011, 27 July 2012, 2-8 August 2012, 19-24 September 2012
*
*   DOCUMENTATION:
...
public class Scores{
    ...
    public void resetDichotomousMissingValues(){
        ...
        if(this.nReplacements>0){
            switch(this.replacementOption){
                case 2: double[][] tscores = this.transpose0to1(this.scores0);
                         boolean[][] tmiss = this.transpose0to1(this.missingScores0);
                         for(int i=0; i<this.nPersons; i++){
                        ...
                        this.scores0 = this.transpose1to0(tscores);
                        break;
    ...
    protected String[][] transpose0to1(String[][]scores00){
     ...
     // Transpose scores0 to scores1 - boolean[][]
    protected boolean[][] transpose0to1(boolean[][]scores00){
        int n0 = scores00.length;
        int n1 = scores00[0].length;
